        ...
        <main>
            <div className="main-bg-container flex gap-3">
                <div className="sidebar-div">
                    <Sidebar className="">
                        <Link to="/home"><SidebarItem icon={<House size={20}/>} text="Home"></SidebarItem></Link>
                        ...
                        <Link to="/reviews"><SidebarItem icon={<Package size={20}/>} text="Reviews" active></SidebarItem></Link>
                        <hr className="my-3"/>
                ...
                <div className="bg-gray-200 w-full rounded-sm bg-container">
                    <div className="content-container p-10">
                        <h2 className="page-title text-pink-600">Reviews</h2>
                    </div>
                </div>
            </div>
        </main>
